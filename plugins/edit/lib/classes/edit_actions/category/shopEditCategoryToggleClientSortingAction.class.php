...
class shopEditCategoryToggleClientSortingAction extends shopEditLoggedAction
{
	...
	protected function execute()
	{
		...
		$affected_category_ids = $category_storage->toggleEnableClientSorting($this->category_selection, $this->toggle);
	...
	{
		return $this->action_options->CATEGORY_TOGGLE_CLIENT_SORTING;
	}
}