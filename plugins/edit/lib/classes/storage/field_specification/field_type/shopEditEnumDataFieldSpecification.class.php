...
class shopEditEnumDataFieldSpecification implements shopEditIDataFieldSpecification
{
	private $enum_options;
	private $default_value;

	public function __construct(shopEditEnumOptions $enum_options, $default_value)
	{
