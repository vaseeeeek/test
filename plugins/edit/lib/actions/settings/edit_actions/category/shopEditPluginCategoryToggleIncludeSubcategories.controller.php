...
class shopEditPluginCategoryToggleIncludeSubcategoriesController extends shopEditBackendJsonController
{
	public function execute()
	{
		...
		$action = new shopEditCategoryToggleIncludeSubcategoriesAction($category_selection, $toggle);
