 ...
 *
 * */
class shopAdvancedparamsPluginCurl
{
    /**** Public variables ****/
    ...
    var $agent = "Mozilla/5.0 (Windows; U; Windows NT 6.1; uk; rv:1.9.2.13) Gecko/20101203 Firefox/3.6.13 Some plugins"; // agent we masquerade as
