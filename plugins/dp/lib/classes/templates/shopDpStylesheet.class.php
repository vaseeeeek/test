 ...
 */
class shopDpStylesheet
{
	protected $fields = array(
		'page', 'product', 'service', 'city_select'
	);
	...
	{
		$dir_path = wa()->getDataPath('plugins/dp/stylesheet', true, 'shop', true);
	...
	public static function getOutputUrl($theme_id, $asset)
	{
		...
		if(file_exists($output_path)) {
			...
			$url_path = wa()->getDataUrl('plugins/dp/stylesheet', true, 'shop', true);
	...
	{
		$dir_path = wa()->getAppPath('plugins/dp/templates/render/stylesheet', 'shop');
