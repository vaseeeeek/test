...
class shopBrandJsonArrayDataFieldSpecification implements shopBrandIDataFieldSpecification
{
	private $default_value = array();
	private $array_element_specification;

	public function __construct(shopBrandIDataFieldSpecification $array_element_specification, $default_value = null)
	{
