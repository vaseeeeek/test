...
abstract class shopBrandCsvImportController extends shopBrandImportexportController
{
	/** @var shopCsvReader */
	private $reader;
	...
	{
		$path = waSystem::getInstance()->getTempPath("brand/csv_import/{$this->processId}") . "/csv_import.csv";
