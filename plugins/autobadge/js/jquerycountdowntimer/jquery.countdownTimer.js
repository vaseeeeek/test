...
(function ($) {
    ...
    $.fn.countdowntimerAB = function (options) {
    ...
    function countdown($this, options) {
        var opts = $.extend({}, $.fn.countdowntimerAB.defaults, options);
        var $this = $this;
        $this.addClass("style");
        var size = "";
        var borderColor = "";
    ...
    function givenDate($this, opts, type) {
        ...
        if ((endDate - startDate) > 0) {
            if (days !== 0 && days.toString().length < 2) {
                days = "0" + days;
            }
            ...
            html($this, (days !== 0 ? days + opts.timeSeparator : '') + hours + opts.timeSeparator + minutes + opts.timeSeparator + seconds);
