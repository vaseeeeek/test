...
class shopAutobadgeProfile
{

    CONST PLUGIN_ID = 'autobadge';
    CONST PLUGIN_ID_SHORT = 'ab';
    CONST PROFILE_FILE = self::PLUGIN_ID . '.profile.log';
    CONST DEFAULT_COOKIE = 'ab-profiling-';
    CONST TAB = '-';
    CONST SETTINGS = [
    ...
    public function __construct()
    {
        ...
        $this->plugins = wa('shop')->getConfig()->getPlugins();
    ...
    public function createProfile()
    {
        if (self::$hook_statistics) {
            $profile = '';
            $profile .= 'Page' . ': ' . wa('shop')->getConfig()->getCurrentUrl() . "\r\n";
            $profile .= "----------------\r\n";
