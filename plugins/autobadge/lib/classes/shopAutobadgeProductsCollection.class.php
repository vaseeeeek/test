...
class shopAutobadgeProductsCollection extends shopProductsCollection
{
    ...
    private function workupProducts(&$products = array(), $escape = true)
    {
        ...
        if ($this->is_frontend && waRequest::param('url_type') == 2 && method_exists($this, 'updateCategoryUrls')) {
        ...
        if ($this->post_fields) {
            ...
            if (!empty($unprocessed['_internal'])) {
                ...
                if (isset($fields['skus'])) {
                    ...
                    if (!empty($this->storefront_context) && method_exists($this, 'promoProductPrices')) {
                ...
                if (isset($fields['frontend_url'])) {
                    foreach ($products as &$p) {
                        ...
                        $p['frontend_url'] = wa('shop')->getRouteUrl('shop/frontend/product', $route_params);
                    }
                    unset($p);
                }
