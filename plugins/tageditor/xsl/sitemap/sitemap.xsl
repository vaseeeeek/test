    ...
    <xsl:template match="/">
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
                <h1>XML Sitemap</h1>
                <p>
                    This sitemap was automatically generated by <a href="https://www.webasyst.com/store/plugin/shop/tageditor/"><strong>Tag editor</strong></a> plugin according to product tags assigned to products available in this Shop-Script settlement.<br />
