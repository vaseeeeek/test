...
/* 
 * IMPORTANT NOTE!
 * This fishki application is a ready-to-use template for developing your own application.
 * To begin the development, copy folder fishki to the folder with your app's name
 * and change at all places fishki to the your app's APP_ID.
 ...
 * Чтобы начинать разработку на основе этого каркаса скопируйте папку fishki в папку с названием вашего приложения,
 * замените везде fishki на APP_ID вашего приложения.
