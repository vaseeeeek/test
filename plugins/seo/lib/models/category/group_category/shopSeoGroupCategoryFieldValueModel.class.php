...
class shopSeoGroupCategoryFieldValueModel extends waModel implements shopSeoGroupCategoryFieldsValuesSource
{
	protected $table = 'shop_seo_group_category_field_value';
