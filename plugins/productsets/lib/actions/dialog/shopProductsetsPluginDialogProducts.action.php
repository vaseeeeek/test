...
class shopProductsetsPluginDialogProductsAction extends waViewAction
{

    public function execute()
    {
        $this->view->assign('categories', $this->getTree());
        $this->view->assign('sets', (new shopSetModel())->getAll('id'));
        $this->view->assign('types', (new shopTypeModel())->getTypes());
        $this->view->assign('plugin_url', wa()->getPlugin('productsets')->getPluginStaticUrl());
    }
